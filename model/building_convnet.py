...
The data for this script is committed in the repository and can be regenerated by running the prep/get-data.sh and
...
hp = {
    ...
    'LEARNING_RATE': float(os.getenv('LEARNING_RATE', 6e-4)),
