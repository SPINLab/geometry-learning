...
The data for this script is committed in the repository and can be generated by running the prep/get-data.sh and
...
if len(sys.argv) > 1 and sys.argv[1] in ['-t', '--test']:
    ...
    TEST_DATA_FILE = '../files/buildings/buildings_test_v4.npz'
